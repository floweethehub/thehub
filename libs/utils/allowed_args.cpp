...
static void addChainSelectionOptions(AllowedArgs& allowedArgs)
{
    allowedArgs
        ...
        .addArg("hf201905-activationtime", requiredInt, "Activation time for the 2019-05 protocol upgrade")
...
static void addConnectionOptions(AllowedArgs& allowedArgs)
{
    allowedArgs
        ...
        .addArg("port=<port>", requiredInt, strprintf(_("Listen for connections on <port> (default: %u or testnet: %u)"), DefaultMainnetPort, DefaultTestnetPort))
