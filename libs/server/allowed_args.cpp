...
static void addConnectionOptions(AllowedArgs& allowedArgs)
{
    allowedArgs
        ...
        .addArg("port=<port>", requiredInt, strprintf(_("Listen for connections on <port> (default: %u, testnet: %u or testnet4: %u)"), DefaultMainnetPort, DefaultTestnetPort, DefaultTestnet4Port))
...
static void addRpcServerOptions(AllowedArgs& allowedArgs)
{
    allowedArgs
        ...
        .addArg("rpcport=<port>", requiredInt, strprintf(_("Listen for JSON-RPC connections on <port> (default: %u, testnet: %u or testnet4: %u)"), BaseParams(CBaseChainParams::MAIN).RPCPort(), BaseParams(CBaseChainParams::TESTNET).RPCPort(), BaseParams(CBaseChainParams::TESTNET4).RPCPort()))
...
HubCli::HubCli()
{
    ...
    addHeader(_("RPC client options:"))
        ...
        .addArg("rpcport=<port>", requiredInt, strprintf(_("Connect to JSON-RPC on <port> (default: %u, testnet: %u or testnet4: %u)"), BaseParams(CBaseChainParams::MAIN).RPCPort(), BaseParams(CBaseChainParams::TESTNET).RPCPort(), BaseParams(CBaseChainParams::TESTNET4).RPCPort()))
