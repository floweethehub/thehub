...
QT_TRANSLATE_NOOP("bitcoin-core", "Listen for JSON-RPC connections on <port> (default: %u, testnet: %u, testnet4: %u or scalenet: %u)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Listen for connections on <port> (default: %u, testnet: %u, testnet4: %u or scalenet: %u)"),
