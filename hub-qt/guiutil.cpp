...
bool isDust(const QString& address, const int64_t& amount)
{
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart)
    {
        ...
        if (SUCCEEDED(hres))
        {
            ...
            QString strArgs = "-min";
            // Set -testnet / -tesetnet4 / -scalenet / -regtest options
            strArgs += QString::fromStdString(strprintf(" -testnet=%d -testnet4=%d -scalenet=%d -regtest=%d", GetBoolArg("-testnet", false), GetBoolArg("-testnet4", false), GetBoolArg("-scalenet", false), GetBoolArg("-regtest", false)));
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    else
    {
        ...
        optionFile << "Exec=" << pszExePath << strprintf(" -min -testnet=%d =testnet4=%d -scalenet=%d -regtest=%d\n", GetBoolArg("-testnet", false), GetBoolArg("-testnet4", false), GetBoolArg("-scalenet", false), GetBoolArg("-regtest", false));
